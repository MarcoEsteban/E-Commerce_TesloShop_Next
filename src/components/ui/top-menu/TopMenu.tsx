  ...
  return (
    <nav className="flex px-5 justify-between items-center w-full">
      ...
      <div className="hidden sm:block">
        ...
        <Link className="m-2 p-2 rounded-md transition-all hover:bg-gray-100" href="/category/men">Homber</Link>
        <Link className="m-2 p-2 rounded-md transition-all hover:bg-gray-100" href="/category/women">Mujere</Link>
